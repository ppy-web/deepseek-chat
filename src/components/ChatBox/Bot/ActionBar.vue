...
<template>
  <div class="action-container">
    ...
    <el-dialog v-model="show" class="dialog-round" width="611px" align-center :show-close="false"
      ...
      <div class="tags-content">
        <div class="tags">
          <div class="tag" v-for="(item, index) in tagsArr" :key="index" :class="{ active: item === feedType }"
            @click="feedType = item">
            {{ item }}
          </div>
        </div>
        <div class="item">
          ...
          <el-input ref="evaluateRef" v-model="evaluteValue" :autosize="{ minRows: 3, maxRows: 5 }" type="textarea"
